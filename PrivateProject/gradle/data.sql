...
-- 기본 회원가입과 로그인이 되면 세션이 살아 있어서 자동로그인 된다.
--  그러므로 로그아웃 (http://localhost:9090/logout)한 후 다시 로그인 해볼것
-- 회원 정보 추가
--자동로그인된다 : 로그아웃(http://localhost:9090/logout)
INSERT INTO USERSJPA(email,password) VALUES('aaa@aaa.com','$2a$10$tdGPsIq7cHAY4Xtlcee9reety4.9A5Ct3lTW6sEltEhFgSdO04yiu');
